...
export default function NavBar() {
  const toggleDisplayBountyQuest = useBountyQuestStore(
    (s) => s.toggleDisplayBountyQuest,
  );
  const toggleDisplayDashboard = useDashboardStore(
    (s) => s.toggleDisplayDashboard,
  );
  ...
  return (
    <div className="flex flex-row h-10 p-1 bg-header shadow-[0_0_2px_rgba(255,255,255,1)] gap-4 items-center justify-center">
      {/* nav div */}
      <div>
        <Button
          variant="exit-btn"
        ...
        <span
          id="lvl-bar"
          className="text-1xl text-gray-200 font-semibold whitespace-nowrap"
        >
          Level: {level}
        </span>
      </div>
